...
- (void) setCameraPositionRepresentation: (Camera*) aCamera
{
	...
	[[mprController originalView] setCrossPositionX: (long)(pos2D[0]+0.5)];
	[[mprController originalView] setCrossPositionY: (long)(pos2D[1]+0.5)];
	...
	[[mprController xReslicedView] setCrossPositionX: (long)(pos2D[0]+0.5)];
	...
	[[mprController yReslicedView] setCrossPositionX: (long)(pos2D[1]+0.5)];
