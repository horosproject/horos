...
- (void) autoRetrieveThread: (NSMutableDictionary*) instance
{
	...
	@try 
	{
		...
		if( [selectedItems count])
		{
			...
			[[AppController sharedAppController] displayUserNotification: NSLocalizedString( @"Q&R Auto-Retrieve", nil) description: desc name: @"autoquery"];
		}
	}
	@catch (NSException * e) 
	{
...
- (void) autoQueryThread: (NSDictionary*) dictionary
{
    ...
    if( autoQuery)
    {
        ...
        {
            [[AppController sharedAppController] displayUserNotification: NSLocalizedString( @"Q&R Auto-Retrieve", nil) description: @"Failed..." name: @"autoquery"];
                    ...
                    if( [[QRInstance objectForKey: @"autoRefreshQueryResults"] intValue] != 0)
                    {
                        if( --autoQueryRemainingSecs[ i] <= 0)
                        {
                            if( [autoQueryLock tryLock])
                            {
                                ...
                                [[AppController sharedAppController] displayUserNotification: NSLocalizedString( @"Q&R Auto-Query", nil) description: NSLocalizedString( @"Refreshing...", nil) name: @"autoquery"];
