...
#pragma clang diagnostic pop
        ...
        {
            [[AppController sharedAppController] displayUserNotification: NSLocalizedString( @"Auto-Query", nil) description: NSLocalizedString( @"DICOM Auto-Query is restarting...", nil)  name:@"autoquery"];
