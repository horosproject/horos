...
#import "CurveFitter.h"
	...
	static int STRAIGHT_LINE=0,POLY2=1,POLY3=2,POLY4=3, EXPONENTIAL=4,POWER=5,LOG=6,RODBARD=7,GAMMA_VARIATE=8;
    static int T1_SAT_RELAX = 9;
    static int T2_DEPHASE = 10;
    static int DIFFUSION = 11;
...
{
	[self doFit: fitType showSettings: FALSE];
}
