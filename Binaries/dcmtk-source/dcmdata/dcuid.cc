...
static const DcmModalityTable modalities[] = {
    ...
    { UID_XRay3DAngiographicImageStorage,                          "XAe", 256 * 512 * 512 },
    { UID_XRay3DCraniofacialImageStorage,                          "DXm", 10 * 4096 * 4096 },
    { UID_BreastTomosynthesisImageStorage,                     "XAe", 256 * 512 * 512 },
	...
	{ UID_OphthalmicPhotography16BitImageStorage,              "OPt", 1500 * 1500 },
    ...
    { UID_EnhancedUSVolumeStorage,                             "US",  1 * 512 * 512 },
