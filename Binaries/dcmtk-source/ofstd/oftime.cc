                                ...
                                const OFBool normalize)
{
    ...
    if (normalize || ((seconds >= 0) && (seconds < 86400)))
    {
        ...
        const double normalSeconds = (normalize) ? seconds + OFstatic_cast(signed int, seconds / 86400) * 86400 : seconds;
                              ...
                              const OFBool normalize)
{
    ...
    if (normalize || ((hours >= 0) && (hours < 24)))
    {
        ...
        const double normalHours = (normalize) ? hours + OFstatic_cast(signed int, hours / 24) * 24 : hours;
